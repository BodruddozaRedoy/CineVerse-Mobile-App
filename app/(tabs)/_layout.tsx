...
const TabIcon = ({ focused, icon, title }: any) => {
  if (focused) {
    return (
      <ImageBackground className='flex flex-row w-full flex-1 min-w-[112px] min-h-16 justify-center items-center mt-4 rounded-full overflow-hidden' source={images.highlight}>
